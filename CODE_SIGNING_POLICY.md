...
- A manually dispatched, non-publishing rehearsal may submit reviewed `master` or `release/*` builds through the same origin-verified policy before an immutable stable tag is created.
