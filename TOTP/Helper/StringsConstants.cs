namespace TOTP.Helper
{
    ...
    {
        public const string ImgCancel = "pack://application:,,,/TOTP;component/Assets/Icons/Cancel.png";
        public const string ImgInfo = "pack://application:,,,/TOTP;component/Assets/Icons/Info.png";
