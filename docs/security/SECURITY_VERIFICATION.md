...
- Authorized Avalonia navigation exposes only Accounts, Tools, or Settings at a time and is unavailable while locked. Leaving Accounts clears generated OTP/QR output without reloading secret-free rows; leaving Tools cancels and clears camera capture. Locking hides the complete authorized shell and clears loaded presentation state.
