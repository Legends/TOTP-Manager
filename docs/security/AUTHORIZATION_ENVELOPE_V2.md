...
- The full Debug solution test run passes 686 tests.
- The Release solution build succeeds with zero warnings and errors, and the filtered PR-like Release test run passes 641 tests.
