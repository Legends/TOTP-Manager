...
| Clipboard | Ownership-aware Windows/macOS/X11 clearing, replacement preservation, explicit write-only fallback warnings, and disabled-auto-clear tests | Physical X11/Wayland/macOS clipboard-manager and history behavior |
