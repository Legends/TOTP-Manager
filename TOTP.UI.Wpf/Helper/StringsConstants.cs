...
namespace TOTP.Helper
{
    internal static class StringsConstants
    {
        ...
        public class ImgUrl
        {
            public const string ImgCancel = "pack://application:,,,/TOTP.UI.Wpf;component/Assets/Icons/Cancel.png";
            public const string ImgInfo = "pack://application:,,,/TOTP.UI.Wpf;component/Assets/Icons/Info.png";
            public const string ImgWarning = "pack://application:,,,/TOTP.UI.Wpf;component/Assets/Icons/warning.png";
            public const string ImgError = "pack://application:,,,/TOTP.UI.Wpf;component/Assets/Icons/Error.png";
            public const string ImgLockAdd = "pack://application:,,,/TOTP.UI.Wpf;component/Assets/Icons/lock-add.png";

            public const string DeFlag = "pack://application:,,,/TOTP.UI.Wpf;component/Assets/flags/de.png";
            public const string EnFlag = "pack://application:,,,/TOTP.UI.Wpf;component/Assets/flags/en.png";
        }
